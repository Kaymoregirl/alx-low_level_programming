...
/**
 * create_buffer - 1024 bytes to be allocated for a buffer
 * @file: Char to be stored in the file name buffer
 *
 * Return: Return pointer to the newly-allocated buffer
 */
 ...
 * @argv: The arguments pointer of an array
 *
